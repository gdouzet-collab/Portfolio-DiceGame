...
function rollDice() {
  ...
  // selecting the dice images based on the roll
  // (Assumes the first two <img> tags on the page are the dice)
...
function whoWon() {
  ...
  document.querySelector("h3").innerHTML =
    banner + "<br>" + outcome + "<br>" + "Your current balance is: $" + balance;
}
...
function letsPlay() {
  ...
  // resetting the balance for this set of rolls
  balance = 0;

  // using a for-loop to roll
